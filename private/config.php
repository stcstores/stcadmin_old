...
$CONFIG = array(
    ...
    'constants' => dirname($_SERVER['DOCUMENT_ROOT']) . '/private/constants.php',
    ...
    'footer' => dirname($_SERVER['DOCUMENT_ROOT']) . '/private/html/footer.php',
    'colours' => dirname($_SERVER['DOCUMENT_ROOT']) . '/public/css/colour_scheme.php',
    ...
    'navbar' => dirname($_SERVER['DOCUMENT_ROOT']) . '/private/html/navbar.php',
